/**
  ******************************************************************************
  * @file    stm32n6570_ai_assistant_lcd.c
  * @author  APAC AI & Smartphone Competence Center
  * @brief   This file includes the driver for Liquid Crystal Display (LCD) module
  *          mounted on AI Assistant board.
  ******************************************************************************
  * @attention
  *
...
static void softspi_configure(void);
...
#define SOFTSPI_CS_START          HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_RESET)
#define SOFTSPI_CS_END            HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_SET)

#define SOFTSPI_DATA_0            HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_RESET)
#define SOFTSPI_DATA_1            HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_SET)

#define SOFTSPI_CLK_LOW           HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET)
#define SOFTSPI_CLK_HIGH          HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_SET)

static void softspi_send_cmd(uint8_t cmd){
	uint8_t mask;
...
static void softspi_send_data(uint8_t data){
	uint8_t mask;
...
static void softspi_msp_init(void){
	/*
	 * 3lines Soft-SPI
	 * PC0 - CLK
	 * PC3 - DATA
    ...
    gpio_init_structure.Pull      = GPIO_NOPULL;
    gpio_init_structure.Speed     = GPIO_SPEED_FREQ_VERY_HIGH; //GPIO_SPEED_FREQ_LOW;
    gpio_init_structure.Mode      = GPIO_MODE_OUTPUT_PP;

    gpio_init_structure.Pin       = GPIO_PIN_0 | GPIO_PIN_3 | GPIO_PIN_5;
    gpio_init_structure.Alternate = GPIO_AF0_SYS;
    HAL_GPIO_Init(GPIOC, &gpio_init_structure);

    HAL_PWREx_DisableVddIO5RangeSTBY();
    HAL_PWREx_ConfigVddIORange(PWR_VDDIO5, PWR_VDDIO_RANGE_1V8);
...
static void softspi_configure(void){
	...
	softspi_send_cmd(0x11);

	HAL_Delay(120); //HAL_Delay 120ms



	softspi_send_cmd(0xFF);

	softspi_send_data(0x77);

	softspi_send_data(0x01);

	softspi_send_data(0x00);

	softspi_send_data(0x00);

	softspi_send_data(0x10);



	softspi_send_cmd(0xC0);

	softspi_send_data(0x3B);

	softspi_send_data(0x00);



	softspi_send_cmd(0xC1);

	softspi_send_data(0x0D);

	softspi_send_data(0x02);



	softspi_send_cmd(0xC2);

	softspi_send_data(0x21);

	softspi_send_data(0x08);



	softspi_send_cmd(0xCD);
	...
	softspi_send_cmd(0xB0);

	softspi_send_data(0x00);

	softspi_send_data(0x11);

	softspi_send_data(0x18);

	softspi_send_data(0x0E);

	softspi_send_data(0x11);

	softspi_send_data(0x06);

	softspi_send_data(0x07);

	softspi_send_data(0x08);

	softspi_send_data(0x07);

	softspi_send_data(0x22);

	softspi_send_data(0x04);

	softspi_send_data(0x12);

	softspi_send_data(0x0F);

	softspi_send_data(0xAA);

	softspi_send_data(0x31);

	softspi_send_data(0x18);



	softspi_send_cmd(0xB1);

	softspi_send_data(0x00);

	softspi_send_data(0x11);

	softspi_send_data(0x19);
	...
	softspi_send_data(0xA9);

	softspi_send_data(0x32);
	...
	softspi_send_data(0x60);



	softspi_send_cmd(0xB1);

	softspi_send_data(0x30);



	softspi_send_cmd(0xB2);

	softspi_send_data(0x87);



	softspi_send_cmd(0xB3);

	softspi_send_data(0x80);



	softspi_send_cmd(0xB5);

	softspi_send_data(0x49);



	softspi_send_cmd(0xB7);

	softspi_send_data(0x85);



	softspi_send_cmd(0xB8);
	...
	softspi_send_cmd(0xE0);

	softspi_send_data(0x00);

	softspi_send_data(0x1B);

	softspi_send_data(0x02);



	softspi_send_cmd(0xE1);

	softspi_send_data(0x08);

	softspi_send_data(0xA0);
	...
	softspi_send_data(0x44);

	softspi_send_data(0x44);



	softspi_send_cmd(0xE2);
	...
	softspi_send_cmd(0xE5);

	softspi_send_data(0x0A);

	softspi_send_data(0xE9);

	softspi_send_data(0xD8);

	softspi_send_data(0xA0);

	softspi_send_data(0x0C);

	softspi_send_data(0xEB);
	...
	softspi_send_cmd(0xE8);

	softspi_send_data(0x09);

	softspi_send_data(0xE8);

	softspi_send_data(0xD8);

	softspi_send_data(0xA0);

	softspi_send_data(0x0B);

	softspi_send_data(0xEA);
	...
	softspi_send_cmd(0xEB);

	softspi_send_data(0x02);

	softspi_send_data(0x00);

	softspi_send_data(0xE4);

	softspi_send_data(0xE4);

	softspi_send_data(0x88);

	softspi_send_data(0x00);

	softspi_send_data(0x40);



	softspi_send_cmd(0xEC);

	softspi_send_data(0x3C);

	softspi_send_data(0x00);



	softspi_send_cmd(0xED);

	softspi_send_data(0xAB);

	softspi_send_data(0x89);

	softspi_send_data(0x76);

	softspi_send_data(0x54);

	softspi_send_data(0x02);

	softspi_send_data(0xFF);
	...
	softspi_send_data(0x20);

	softspi_send_data(0x45);

	softspi_send_data(0x67);

	softspi_send_data(0x98);



	softspi_send_data(0xBA);
	...
	/* Display Brightness */
	softspi_send_cmd(0x51);
	softspi_send_data(0xF0);

	/* CTRL Display */
	softspi_send_cmd(0x53);
	softspi_send_data(0x2C);


	softspi_send_cmd(0x36);

	softspi_send_data(0x00); //08

	softspi_send_cmd(0x3A); /* Interface Pixel Format */

	softspi_send_data(0x66); /* 18-bit/pixel */


	softspi_send_cmd(0x21); //


	HAL_Delay (120);

	softspi_send_cmd(0x29);

	/* disable VddIO5 to save power */
    HAL_PWREx_EnableVddIO5RangeSTBY();
...
static void LTDC_MspInit(LTDC_HandleTypeDef *hltdc)
{
  ...
  if (hltdc->Instance == LTDC)
  {
    ...
    //
    HAL_GPIO_WritePin(GPIOE, GPIO_PIN_7, GPIO_PIN_RESET); /* LCD Power Control */

    HAL_GPIO_WritePin(GPIOQ, GPIO_PIN_3, GPIO_PIN_RESET); /* NRST active */
    HAL_Delay(10);
    HAL_GPIO_WritePin(GPIOQ, GPIO_PIN_3, GPIO_PIN_SET); /* NRST de-active */
