...
#define BUS_I2C4_SDA_GPIO_CLK_ENABLE()         __HAL_RCC_GPIOE_CLK_ENABLE()
#define BUS_I2C4_SDA_GPIO_CLK_DISABLE()        __HAL_RCC_GPIOE_CLK_DISABLE()
...
#define BUS_I2C4_SCL_PIN                       GPIO_PIN_13
#define BUS_I2C4_SDA_PIN                       GPIO_PIN_14
#define BUS_I2C4_SCL_GPIO_PORT                 GPIOE
#define BUS_I2C4_SDA_GPIO_PORT                 GPIOE
