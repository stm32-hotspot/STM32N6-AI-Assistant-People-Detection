...
#if (defined(USE_AI_ASSISTANT) && (USE_AI_ASSISTANT == 1))
/* USER_KEY1 PD-10 */
#define BUTTON_USER1_PIN                   GPIO_PIN_10
...
#define BUTTON_USER1_EXTI_IRQn             EXTI10_IRQn
#define BUTTON_USER1_EXTI_LINE             EXTI_LINE_10
#else
...
#if (defined(USE_AI_ASSISTANT) && (USE_AI_ASSISTANT == 1))
/* USER_KEY2 PD-12 */
#define BUTTON_TAMP_PIN                   GPIO_PIN_12
#define BUTTON_TAMP_GPIO_PORT             GPIOD
#define BUTTON_TAMP_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOD_CLK_ENABLE()
#define BUTTON_TAMP_GPIO_CLK_DISABLE()    __HAL_RCC_GPIOD_CLK_DISABLE()
#define BUTTON_TAMP_EXTI_IRQn             EXTI12_IRQn
#define BUTTON_TAMP_EXTI_LINE             EXTI_LINE_12
#else
...
#if (defined(USE_AI_ASSISTANT) && (USE_AI_ASSISTANT == 1))
/**
 * @brief Definition for COM port1, connected to USART5
 */
#define COM1_UART                      UART5

#define COM1_CLK_ENABLE()             __HAL_RCC_UART5_CLK_ENABLE()
#define COM1_CLK_DISABLE()            __HAL_RCC_UART5_CLK_DISABLE()
...
#define COM1_TX_AF                    GPIO_AF11_UART5

#define COM1_RX_PIN                   GPIO_PIN_2
#define COM1_RX_GPIO_PORT             GPIOH
#define COM1_RX_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOH_CLK_ENABLE()
#define COM1_RX_GPIO_CLK_DISABLE()    __HAL_RCC_GPIOH_CLK_DISABLE()
#define COM1_RX_AF                    GPIO_AF11_UART5

#define COM1_IRQ                      UART5_IRQn

/**
 * @brief Definition for COM port2, connected to USART4
 */
#define COM2_UART                      UART4
#define COM2_CLK_ENABLE()             __HAL_RCC_UART4_CLK_ENABLE()
#define COM2_CLK_DISABLE()            __HAL_RCC_UART4_CLK_DISABLE()

#define COM2_TX_PIN                   GPIO_PIN_1
